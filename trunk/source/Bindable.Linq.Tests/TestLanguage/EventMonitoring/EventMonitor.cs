...
namespace Bindable.Linq.Tests.TestLanguage.EventMonitoring
{
    ...
    /// </summary>
    internal abstract class EventMonitor<TPublisher, TEventArgs> : IDisposable
        where TPublisher : class
    {
        private Queue<CapturedEvent<TEventArgs>> _capturedEvents = new Queue<CapturedEvent<TEventArgs>>();
        private TPublisher _publisher;

        /// <summary>
        /// Initializes a new instance of the <see cref="EventMonitor&lt;TPublisher, TEventArgs&gt;"/> class.
        /// </summary>
        /// <param name="publisher">The publisher.</param>
        public EventMonitor(TPublisher publisher)
        {
